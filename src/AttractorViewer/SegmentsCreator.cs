...
public class SegmentsCreator
{
    ...
    public SegmentsCreator()
    {

    }

    public GeometryModel3D CreateModel(Material material, Point3D point1, Point3D point2, double thickness)
    {
        ...
        // Add the segment.
        AddSegment(mesh, point1, point2, up, thickness);

        return new GeometryModel3D(mesh, material);
    }

    public void AddSegment(MeshGeometry3D mesh, Point3D point1, Point3D point2, Vector3D up, double thickness)
    {
